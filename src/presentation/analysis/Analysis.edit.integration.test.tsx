...
describe('Analysis edit -> save flow', () => {
  ...
  it('opens detail, goes into edit mode and saves changes', async () => {
    ...
    vi.spyOn(LocalStorageAnalysisRepository.prototype, 'getById').mockResolvedValue(sample)

    const saveSpy = vi
      .spyOn(LocalStorageAnalysisRepository.prototype, 'save')
      .mockResolvedValue()
