...
describe('InMemoryAnalysisRepository', () => {
  ...
  it('saves and retrieves by id', async () => {
    const a = AnalysisFactory.create({ id: 'a1', symbol: 'EURUSD', createdAt: new Date().toISOString() })
  ...
  it('lists by symbol', async () => {
    const a1 = AnalysisFactory.create({ id: 'a1', symbol: 'EURUSD', createdAt: new Date().toISOString() })
    const a2 = AnalysisFactory.create({ id: 'a2', symbol: 'BTCUSD', createdAt: new Date().toISOString() })
